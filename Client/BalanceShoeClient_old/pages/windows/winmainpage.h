 ...
 */
#ifndef WINMAINPAGE_H
#define WINMAINPAGE_H
...
namespace haevn::esp::pages{
   /**
     * @brief The WinMainPage class This lass contains the logic to handle main page
     * @details This class contains the logic for the main page
     *          At this page it is possible to invoke different settings
     *          it is also possible to start the ESP.
     * @author Nils Milewski (nimile/10010480)
     */
    class WinMainPage : public QWidget{
    ...
    public methods:
        ...
        /**
          * @brief WinMainPage This is a constructor.
          ...
          * @author Nils Milewski (nimile/10010480)
          */
        WinMainPage(QWidget* parent = nullptr);
