 ...
 */
#ifndef ANDROIDUSERSETTINGSPAGE_H
#define ANDROIDUSERSETTINGSPAGE_H
...
namespace haevn::esp::pages{
     ...
     * @author Nils Milewski (nimile/10010480)
     */
    class AndroidUserSettingsPage : public QWidget{
    ...
    public methods:
        ...
        /**
         * @brief AndroidUserSettingsPage This is a constructor.
         ...
         * @author Nils Milewski (nimile/10010480)
         */
        AndroidUserSettingsPage(QWidget* parent = nullptr);
...
#endif // ANDROIDUSERSETTINGSPAGE_H
