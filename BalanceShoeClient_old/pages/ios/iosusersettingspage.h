 ...
 */
#ifndef IOSUSERSETTINGSPAGE_H
#define IOSUSERSETTINGSPAGE_H
...
namespace haevn::esp::pages{
     ...
     * @author Nils Milewski (nimile/10010480)
     */
    class IosUserSettingsPage : public QWidget{
    ...
    public methods:
        ...
        /**
         * @brief IOSUserSettingsPage This is a constructor.
         ...
         * @author Nils Milewski (nimile/10010480)
         */
        IosUserSettingsPage(QWidget* parent = nullptr);
    ...
    private methods:
         ...
         *          layout. If its set to an Ios compiler it will create a layout
         *          which is specialized for an Ios device.
