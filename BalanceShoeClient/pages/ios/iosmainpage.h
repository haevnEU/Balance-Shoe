 ...
 */
#ifndef IOSMAINPAGE_H
#define IOSMAINPAGE_H
...
namespace haevn::esp::pages{
   /**
     * @brief The IosMainPage class This lass contains the logic to handle main page
     * @details This class contains the logic for the main page
     *          At this page it is possible to invoke different settings
     *          it is also possible to start the ESP.
     * @author Nils Milewski (nimile/10010480)
     */
    class IosMainPage : public QWidget{
    ...
    public methods:
        ...
        /**
          * @brief IosMainPage This is a constructor.
          ...
          * @author Nils Milewski (nimile/10010480)
          */
        IosMainPage(QWidget* parent = nullptr);
